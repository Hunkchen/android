...
public class DrawActivity extends AppCompatActivity implements View.OnClickListener, BaiduMap.OnMarkerClickListener, BaiduMap.OnMapClickListener, BaiduMap.OnMarkerDragListener {
        ...
        if (view.getId() == R.id.btn_yes) {
            ...
            builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    if (trim.equals("")) {
                        Toast.makeText(DrawActivity.this, "别名不能为空！", Toast.LENGTH_SHORT).show();
                        return;
                    }
            ...
            for (int i = 0; i < aliasname.size(); i++) {
                ...
                Log.e("aaa", "sssss---->" + s);
                //判断一个点是否在多边形中
                polygonContainsPoint = SpatialRelationUtil.isPolygonContainsPoint(polygon.getPoints(), new LatLng(data.latitude, data.longitude));
            ...
            if (areas.size() > 0) {
                ...
                String s = "你已经越过电子栅栏，请返回栅栏区域！！！";
                PendingIntent pi = PendingIntent.getActivity(DrawActivity.this,0,new Intent(),0);
                smsManager.sendTextMessage("15750723533",null,s,pi,null);
                showDialog("该点不在任何区域内，并发送信息！");
            }
    ...
    public void onMarkerDragEnd(Marker marker) {
        ...
        Toast.makeText(DrawActivity.this, "拖拽结束，新位置：" + latitude1 + ", " + longitude1, Toast.LENGTH_LONG).show();
    ...
    private void showInfo(String str) {
        Toast.makeText(DrawActivity.this, str, Toast.LENGTH_SHORT).show();
    }
    ...
    private void initView() {
        ...
        btnYes.setOnClickListener(DrawActivity.this);
        btnClear = (Button) findViewById(R.id.btn_clear);
        btnClear.setOnClickListener(DrawActivity.this);
        location = (ImageView) findViewById(R.id.location);
        location.setOnClickListener(DrawActivity.this);
        ...
        btnCheck.setOnClickListener(DrawActivity.this);
    }
