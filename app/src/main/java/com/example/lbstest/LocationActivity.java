...
public class LocationActivity extends Activity {
    ...
    public class MyLocationListener extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            textViewAddText(mTvLog,"纬度: "+latitude+"     经度: "+longitude);

            String addr = location.getAddrStr();    //获取详细地址信息
            textViewAddText(mTvLog,"详细地址: "+addr);
            String country = location.getCountry();    //获取国家
            textViewAddText(mTvLog,"国家: "+country);
            String province = location.getProvince();    //获取省份
            textViewAddText(mTvLog,"省份: "+province);
            String city = location.getCity();    //获取城市
            textViewAddText(mTvLog,"城市: "+city);
            String district = location.getDistrict();    //获取区县
            textViewAddText(mTvLog,"区县: "+district);
            String street = location.getStreet();    //获取街道信息
            textViewAddText(mTvLog,"街道: "+street);

            String locationDescribe = location.getLocationDescribe();    //获取位置描述信息
            textViewAddText(mTvLog,"位置描述: "+locationDescribe);
